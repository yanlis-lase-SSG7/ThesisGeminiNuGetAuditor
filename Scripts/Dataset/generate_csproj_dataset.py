...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate 1.000 file .csproj .NET 10 menggunakan Vertex AI Gemini."
    )
    parser.add_argument("--project-id", default=DEFAULT_PROJECT_ID, help="Google Cloud project id untuk Vertex AI.")
    ...
    if not args.project_id:
        raise ValueError("Project id wajib diisi. Gunakan --project-id atau environment variable GOOGLE_CLOUD_PROJECT.")
